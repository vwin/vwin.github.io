...
5. 可以使用YII建立RABC权限管理
[yii2+AdminLTE搭建完美后台并实现rbac权限控制实例教程](https://segmentfault.com/a/1190000004963496)
6. Laravel建立RABC权限管理
[在Laravel5.* 中使用](AdminLTE https://segmentfault.com/a/1190000003917210)
